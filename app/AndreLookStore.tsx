...
type Language = "ru" | "en" | "et";
type BrandId = "moncler" | "parajumpers" | "cpcompany";
...
const AndreLookStore: React.FC = () => {
  const [currentView, setCurrentView] = useState<
    "home" | "about" | "catalog" | "product" | "account" | "admin"
  >("home");
  ...
  const translations: Record<Language, Translation> = {
    ru: {
      ...
      aboutTitle: "О нас",
      aboutText:
        "AndreLook - это эксклюзивный бутик премиальной одежды в сердце Европы. Мы специализируемся на продаже оригинальных коллекций ведущих европейских брендов.",
      name: "Имя и фамилия",
      email: "Email",
      phone: "Телефон",
    ...
    en: {
      ...
      heroSubtitle:
        "Original Moncler, Parajumpers and CP Company collections with delivery across Europe",
      ...
      aboutTitle: "About Us",
      aboutText:
        "AndreLook is an exclusive premium clothing boutique in the heart of Europe. We specialize in selling original collections of leading European brands.",
      name: "Full Name",
      email: "Email",
      phone: "Phone",
    ...
    et: {
      ...
      heroSubtitle:
        "Originaalsed Moncler, Parajumpers ja CP Company kollektsioonid",
      ...
      aboutTitle: "Meist",
      aboutText:
        "AndreLook on eksklusiivsete premium-rõivaste butik Euroopa südames. Spetsialiseerume juhtivate Euroopa brändide müügile.",
      name: "Nimi",
      email: "E-post",
      phone: "Telefon",
  ...
  const brands: { id: BrandId; name: string; image: string }[] = [
    {
      id: "moncler",
      name: "Moncler",
      image:
  ...
  const products: Record<BrandId, Product[]> = {
    ...
    parajumpers: [
      ...
      },
      {
        ...
        brand: "Parajumpers",
        image:
          "https://images.unsplash.com/photo-1548126032-bb70f9b01578?w=600",
        rating: 5,
        description: {
    ...
    <div className="min-h-screen bg-stone-50">
        ...
        <div className="max-w-7xl mx-auto px-4 py-4">
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-8">
              ...
              >
                <div className="text-4xl font-serif text-stone-800 tracking-tight">
                  AL
                </div>
                <div className="text-xl font-light text-stone-700 tracking-widest">
                  ANDRELOOK
                </div>
              </div>
              <nav className="hidden md:flex gap-6">
                <button
                  ...
                  className="text-stone-600 hover:text-stone-900 transition text-sm tracking-wide"
                >
                  {t.home}
                </button>
                <button className="text-stone-600 hover:text-stone-900 transition text-sm tracking-wide">
                  {t.brands}
                </button>
                <button
        ...
        <main className="max-w-7xl mx-auto px-4 py-12">
          <div className="bg-gradient-to-br from-stone-800 via-stone-700 to-stone-600 rounded-2xl p-16 mb-16 text-white relative overflow-hidden">
            <div className="relative z-10">
              ...
              <p className="text-xl mb-12 text-stone-200 max-w-2xl font-light">
                {t.heroSubtitle}
              </p>
          ...
          <h3 className="text-3xl font-light text-stone-800 mb-12 tracking-tight">
            {t.selectBrand}
          </h3>
          <div className="grid md:grid-cols-3 gap-8 mb-16">
            {brands.map((brand) => (
              ...
              >
                ...
                <div className="p-8">
                  <h4 className="text-2xl font-light text-stone-800 mb-3 tracking-tight">
                    {brand.name}
                  </h4>
          ...
          <div className="grid md:grid-cols-3 gap-8">
            <div className="bg-white rounded-xl p-8 text-center border border-stone-200">
              ...
              <h4 className="font-light text-lg mb-3 text-stone-800">
                {t.guarantee}
              </h4>
      ...
      {currentView === "about" && (
        <main className="max-w-4xl mx-auto px-4 py-16">
          <h2 className="text-4xl font-light text-stone-800 mb-8 tracking-tight">
            {t.aboutTitle}
          </h2>
          <div className="bg-white rounded-xl p-12 border border-stone-200">
            <p className="text-stone-700 leading-relaxed text-lg font-light mb-8">
              {t.aboutText}
            </p>
            <div className="grid md:grid-cols-2 gap-8 mt-12">
              <div className="flex items-start gap-4">
                ...
                <div>
                  <h4 className="font-light text-stone-800 mb-2">
                    Tallinn, Estonia
                  </h4>
                  <p className="text-stone-600 text-sm font-light">
                    Heart of Europe
                ...
                <div className="p-6">
                  <div className="flex items-center gap-1 mb-3">
                    {[...Array(product.rating)].map((_, i) => (
                      <Star
                        key={i}
                        className="w-4 h-4 fill-stone-700 text-stone-700"
                      />
                    ))}
                  </div>
        ...
        <main className="max-w-7xl mx-auto px-4 py-12">
          ...
          <div className="grid md:grid-cols-2 gap-12 bg-white rounded-2xl overflow-hidden border border-stone-200 p-8">
            ...
            <div className="flex flex-col">
              <div className="text-sm text-stone-600 font-light mb-3 tracking-wide">
                {selectedProduct.brand}
              </div>
              <h2 className="text-4xl font-light text-stone-800 mb-6 tracking-tight">
              ...
              <div className="flex items-center gap-2 mb-8">
                {[...Array(selectedProduct.rating)].map((_, i) => (
                  <Star
                    key={i}
                    className="w-5 h-5 fill-stone-700 text-stone-700"
                  />
                ))}
              </div>

              <div className="text-4xl font-light text-stone-800 mb-10">
      ...
      {currentView === "account" && isLoggedIn && (
        <main className="max-w-4xl mx-auto px-4 py-12">
          ...
          <div className="bg-white rounded-xl p-8 border border-stone-200 mb-8">
            <h3 className="text-xl font-light text-stone-800 mb-6">
              {t.myOrders}
            </h3>
            <div className="space-y-4">
              {mockOrders.map((order) => (
                <div
                  key={order.id}
                  className="border border-stone-200 rounded-lg p-6 hover:border-stone-400 transition"
                >
      ...
      {currentView === "admin" && isAdmin && (
        <main className="max-w-7xl mx-auto px-4 py-12">
          <h2 className="text-3xl font-light text-stone-800 mb-8 tracking-tight">
            {t.adminPanel}
          </h2>
            ...
            <div className="overflow-x-auto">
              <table className="w-full">
                <thead className="bg-stone-50">
                  <tr>
                    <th className="px-6 py-3 text-left text-xs font-light text-stone-600 tracking-wide">
                      Name
                    </th>
                    <th className="px-6 py-3 text-left text-xs font-light text-stone-600 tracking-wide">
                      Email
                ...
                <tbody>
                  {mockCustomers.map((customer) => (
                    ...
                    >
                      <td className="px-6 py-4 text-sm font-light text-stone-800">
                        {customer.name}
                      </td>
                      <td className="px-6 py-4 text-sm font-light text-stone-600">
                        {customer.email}
                      </td>
                      <td className="px-6 py-4 text-sm font-light text-stone-800">
                        {customer.orders}
            ...
            {!orderComplete ? (
                      ...
                      <>
                        <div className="space-y-4 mb-6">
                          {cart.map((item) => (
                            <div
                              key={item.id}
                              className="flex gap-4 bg-stone-50 p-4 rounded-xl border border-stone-200"
                            >
                              <img
                                src={item.image}
                                alt={item.name}
                              ...
                              <div className="flex-1">
                                <h4 className="font-light text-stone-800">
                                  {item.name}
                                </h4>
                  ...
                  <div className="p-6">
                    ...
                    <div className="space-y-4">
                      ...
                      <div>
                        ...
                        <select className="w-full border border-stone-300 rounded-lg px-4 py-3 focus:ring-2 focus:ring-stone-400 focus:border-transparent font-light">
              ...
              <div className="flex items-center justify-center h-full p-8">
                <div className="text-center">
                  ...
                  <h3 className="text-3xl font-light text-stone-800 mb-4 tracking-tight">
                    {t.orderSuccess}
                  </h3>
                  <p className="text-stone-600 mb-2 font-light">
                    {t.thankYou}
                  </p>
